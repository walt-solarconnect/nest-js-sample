...
export class Logger implements LoggerService {
  ...
  constructor(@Optional() protected context?: string, @Optional() private readonly isTimestampEnabled = false) {
    Logger.appName = (context || process.env.APP_NAME || 'NONAME').toUpperCase();
  }
  ...
  static log(message: any, context = '', isTimeDiffEnabled = true) {
    this.printMessage(this.appName, message, clc.green, context, isTimeDiffEnabled);
  }

  static error(message: any, trace = '', context = '', isTimeDiffEnabled = true) {
    this.printMessage(this.appName, message, clc.red, context, isTimeDiffEnabled);
    this.printStackTrace(trace);
  }

  static warn(message: any, context = '', isTimeDiffEnabled = true) {
    this.printMessage(this.appName, message, clc.yellow, context, isTimeDiffEnabled);
  }

  static debug(message: any, context = '', isTimeDiffEnabled = true) {
    this.printMessage(this.appName, message, clc.magentaBright, context, isTimeDiffEnabled);
  }

  static verbose(message: any, context = '', isTimeDiffEnabled = true) {
    this.printMessage(this.appName, message, clc.cyanBright, context, isTimeDiffEnabled);
  }
